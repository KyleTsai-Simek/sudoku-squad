...
- End-game share links with result-aware Open Graph images; being revised to short `/s/{code}/{time}` routes with daily-preserving play links and external unfurl validation.
