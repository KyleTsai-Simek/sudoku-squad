...
- [x] Presence-filtered public lobby browsing 2026-06-29 ([DECISIONS #0054](DECISIONS.md)): migration `0027` adds `get_public_lobbies`, the home list only shows public lobby-status rooms with recent confirmed presence, and started games disappear from public browsing while direct `/r/{code}` links continue to join.
